...
<section class="about-us content-two">
    <div>
        <h2><?php _text('AU B2 Content 1 Description will be place here...')?></h2>
        <h3><?php _text('AU B2 Content 2 Description will be place here...')?></h3>
        <div class="content row">
            <div class="col-sm-4">
                <div class="cover">
                    ...
                    <div class="desc">
                        <?php _text('AU B2 Image 1 Description')?>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="cover">
                    ...
                    <div class="desc">
                        <?php _text('AU B2 Image 2 Description')?>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="cover">
                    ...
                    <div class="desc">
                        <?php _text('AU B2 Image 3 Description')?>
                    </div>
                </div>
            </div>
        </div>
