...
<section class="testing content-two">
    <div>
        <div class="line-faq">
            ...
            <div class="desc">
                <div><?php _text("If you're having problems with video on a Skype call, and you've already tried the steps in the Connection Troubleshooter
                , there are a few things you can check to make sure your webcam is working properly.")?></div>
                <div><?php _text('Skype for Windows Desktop')?></div>
                <div><?php _text("Before proceeding with the troubleshooting steps below, first ensure that you are in a room with proper lighting 
                (bad lighting can make your video too dark to be seen by the people you're calling.")?></div>
                <div><?php _text("Is your webcam working properly with Skype?")?></div>
                <div><?php _text("To make sure that your webcam is working correctly with Skype:")?></div>
                <div class="indent">
                    <div><?php _text("1. Sign into Skype.")?></div>
                        <div><?php _text("2. In the menu bar, click <strong>Tools</strong> &gt; <strong>Options</strong>...
                                    ")?>
                    </div>
