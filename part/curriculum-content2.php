<?php
wp_enqueue_style('curriculum-content2', td() . '/css/curriculum-content2.css');
?>
<section class="curriculum content-two">
    <div>
        <h2><?php _e('Video English Curriculum', 'x5')?></h2>
        <div class="desc"><?php _e('This is the first paragraph of the Curriculum page. You can use HTML to decorate on the text. Try to use p, br, b, i tags. You can also input CSS and Javascript on this paragraph.', 'x5')?></div>
        <div class="container container-level">
            <div class="row">
                <div class="beginner col-xs-12 col-sm-4">
                    ...
                    <div class="level-desc"><?php _e('Topic 토론, Cartoon Story Making,원어민 Idiom 표현, 영어 대화의 논리력 연습', 'x5')?></div>
