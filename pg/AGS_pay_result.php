...
<section class="AGS_pay payment content-two">

	<div>
		<div class="row">
			<div class="header-summary col-sm-6">
				<img src="<?php img_e() ?>payment_result.png">
				<div class="title">Payment<span>Summary</span></div>
			</div>
			<div class="header col-sm-6 right">
				<div class="title">
					<?php
					if ( $AuthTy == 'card' ) {
						echo "수업료 카드결재";
